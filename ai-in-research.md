...
LLMs generate plausible-sounding text. They don't "know" things the way a scholar does. Treat AI output as a draft to be interrogated, not a finding to be cited.

### 2. Verify everything against primary sources
AI models can and do fabricate citations, misrepresent arguments, and get facts wrong (often called "hallucination"). Any factual claim that comes from an AI should be verified before it enters your work.

### 3. Transparency matters
If you used AI tools in your research, say so. Many journals and institutions are developing policies on AI disclosure. Even where policies don't yet exist, intellectual honesty calls for transparency.
...
- **Archival research.** AI cannot visit archives, read handwriting in context, or understand the materiality of sources.
- **Close reading.** AI can summarize a text, but it cannot perform the kind of sustained, interpretive engagement that humanistic scholarship requires.
- **Ethical judgment.** Decisions about how to represent communities, handle sensitive material, or navigate power dynamics in research require human judgment.
- **Citation and attribution.** Never cite a source you haven't read yourself, even if an AI told you about it.
