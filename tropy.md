...
A free, open-source tool for organizing and describing your archival research photos.
{: .fs-5 .fw-300 }
...
### 4. Understand items vs. photos (5 min)
...
- Right-click → Merge selected items

**Exercise:** Find a few photos that belong together and merge them into a single item.
...
- The selection appears as a sub-item you can add its own notes and tags to
